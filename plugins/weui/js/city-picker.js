  ...
  $.fn.cityPicker = function(params) {
    ...
    return this.each(function() {
      ...
      var config = {
        ...
        onClose:function(picker,type){
          if(type=='close'){
            picker.updateInput();
          }else if(type=='cancel'){
            var inputArr = picker.input.val().split(" ");
            picker.cols[0].updateItems(provinces.indexOf(inputArr[0]));

            var oldcity = getCities(inputArr[0]);
            picker.cols[1].replaceValues(oldcity);
            picker.cols[1].updateItems(oldcity.indexOf(inputArr[1]));

            var olddistrict = getDistricts(inputArr[0],inputArr[1]);
            picker.cols[2].replaceValues(olddistrict);
            picker.cols[2].updateItems(olddistrict.indexOf(inputArr[2]));
          }
        },
        cols: cols
      };
